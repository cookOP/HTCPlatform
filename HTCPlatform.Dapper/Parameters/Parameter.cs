...
namespace HTCPlatform.Dapper.Parameters
{
    ...
    public class Parameter
    {
        ...
        public Parameter(string name, object value, OperateType operateType = OperateType.Equal, LogicType logicType = LogicType.And)
        {
            Name = name;
            OperateType = operateType;
            Value = value;
    ...
    public static class BuildSqlParameter
    {
        ...
        public static string GetSqlStringOp(string fields, string tables, Parameter[] pars, string orderby, int pageIndex, int length, ref string sqlcount, ref DynamicParameters dp)
        {
            if (length == -1)
            {
                ...
                dp = GetDynamicParameter(ref wherefield, pars);
